function bias_correct(ImagePath)
%bias_correct: correct bias field of structural MRI based on SPM12 unified
%segmentation
%
% Renaud Marquis @ FBM lab, March 2018

clear matlabbatch
matlabbatch{1}.spm.spatial.preproc.channel.vols = {[ImagePath,',1']};
