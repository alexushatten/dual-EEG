function [k_corner,info] = l_corner(rho,eta,fig)
...
% RM@FBMlab: took this function from TAPEEG external dependency "regtools"
% and renamed function "l_corner" (although there is another similar function
% named "l_corner" in the regtools, but that is the one called by TAPEEG).
% The output of this function seems to match Cartool's result, provided that
% "rho" is the "average norm of all solution points" and "eta" holds the Tikhonov
