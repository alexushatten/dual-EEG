...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Moses (2020). spider_plot (https://www.github.com/NewGuy012/spider_plot), GitHub. Retrieved April 16, 2019.
...
% Gabriela Andrade's fix
% (https://ch.mathworks.com/matlabcentral/fileexchange/59561-spider-radar-plot)
