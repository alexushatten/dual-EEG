function h = plot_hdEEG( EEG, Srate, ChanelLabels, Offset, EEGoverlay )
% plot_EEG: plot EEG
%
...
if nargin < 3
    ChanelLabels = cellstr(num2str([1:size(EEG,2)]'));
end
...
if nargin > 4
    highlightChannel(H,repmat(flip(ChanelLabels),2,1));
else
