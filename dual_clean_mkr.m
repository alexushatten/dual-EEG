...
[mkr, NonNumMark, multi_ones, MultiOnes, delta, DoubletsGaps, ExtraMarkersDiscarded, icEEGbutNOThdEEG, hdEEGbutNOTicEEG, mkr1, mkr2, idx, markers1,markers2,folder1,folder2,folder,fid,WarningMessage] = clean_mkr_part1(markers1,markers2,folder1,folder2,folder,fid,WarningMessage); %#ok<ASGLU>
...
if any(diff(mkr1(:,2))<0) || any(diff(mkr2(:,2))<0)
    ...
    [mkr, delta, mkr1, mkr2, DoubletsGaps, ExtraMarkersDiscarded, markers1,markers2,folder1,folder2,folder,fid,WarningMessage] = clean_mkr_unwrap(markers1,markers2,folder1,folder2,folder,fid,WarningMessage); %#ok<ASGLU>
...
function [mkr, NonNumMark, multi_ones, MultiOnes, delta, DoubletsGaps, ExtraMarkersDiscarded, icEEGbutNOThdEEG, hdEEGbutNOTicEEG, mkr1, mkr2, idx, markers1,markers2,folder1,folder2,folder,fid,WarningMessage] = clean_mkr_part1(markers1,markers2,folder1,folder2,folder,fid,WarningMessage,varargin)
...
function [mkr, delta, mkr1, mkr2, DoubletsGaps, ExtraMarkersDiscarded, markers1,markers2,folder1,folder2,folder,fid,WarningMessage] = clean_mkr_unwrap(markers1,markers2,folder1,folder2,folder,fid,WarningMessage,varargin)
